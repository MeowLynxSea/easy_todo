...
class _PomodoroSettingsScreenState extends State<PomodoroSettingsScreen> {
                  ...
                  children: [
                    ...
                    _buildDurationSetting(
                      ...
                      (value) {
                        ...
                        if (minutes > 0) {
                          _pomodoroProvider.updateSettings(workDuration: minutes * 60);
                        }
                      },
                    ),
                    const SizedBox(height: 16),
                    _buildDurationSetting(
                      ...
                      (value) {
                        ...
                        if (minutes > 0) {
                          _pomodoroProvider.updateSettings(breakDuration: minutes * 60);
                        }
                      },
                    ),
                    const SizedBox(height: 16),
  ...
  void _saveSettings() {
    ...
    final longBreakMinutes = int.tryParse(_longBreakDurationController.text) ?? 15;
